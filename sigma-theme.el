;;; sigma-theme.el --- SIGMA theme -*- lexical-binding: t -*-
...
;;;###autoload
(deftheme sigma "SIGMA theme.")

(sigma-theme 'sigma (frame-parameter (selected-frame) 'background-mode))

(provide-theme 'sigma)
;;; sigma-theme.el ends here
